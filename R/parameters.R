#' Obtaining summary statistics about the network degree.
#'
#' This function calculates some basic statistic to describe the network degree
#' distribution.
#' @inheritParams Oempdegreedistrib
#' @return a list consisting of:
#'    \item{realdd}{a vector of length \code{net$n} each element corresponds to
#'          the degree of a node in the network.}
#'    \item{rmean}{a numeric vector of length one that is the atrithmetic mean
#'          of \code{realdd}. see \code{\link[base]{mean}}.}
#'    \item{rquart}{the lower, median, and upper quartiles of \code{realdd}.}
...
#'          \code{realdd} in increasing order.}
#'    @export
